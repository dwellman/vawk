...
class VawkLintServiceTest {

    @Test
    void lintWritesLogWhenPlanPresent() throws Exception {
        StubSessionLogRepository sessionLogRepository = new StubSessionLogRepository();
        VawkLintService service = new VawkLintService(
        ...
        AiResponse response = service.lint(new AwkProgram(Path.of("main.awk"), "code", "hash"), null);
    ...
    @Test
    void lintUsesModelOverrideAndSpecHash(@org.junit.jupiter.api.io.TempDir java.nio.file.Path tempDir) throws Exception {
        StubSessionLogRepository sessionLogRepository = new StubSessionLogRepository();
        VawkLintService service = new VawkLintService(
                new StubAgents(validResponse()),
        ...
        try {
            ...
            service.lint(new AwkProgram(Path.of("main.awk"), "code", "hash"), "override");
    ...
    @Test
    void lintThrowsWhenPlanMissing() {
        VawkLintService service = new VawkLintService(
        ...
        assertThrows(IllegalStateException.class, () -> service.lint(new AwkProgram(Path.of("main.awk"), "code", "hash"), null));
    }

    @Test
    void lintThrowsWhenResponseNull() {
        VawkLintService service = new VawkLintService(
                new StubAgents(null),
                new StubAgentsFileRepository(Optional.empty()),
                new ProgramRepository(),
    ...
    @Test
    void lintUsesDefaultModelWhenOverrideBlank() throws Exception {
        StubSessionLogRepository sessionLogRepository = new StubSessionLogRepository();
        VawkLintService service = new VawkLintService(
                new StubAgents(validResponse()),
                new StubAgentsFileRepository(Optional.empty()),
        ...
        service.lint(new AwkProgram(Path.of("main.awk"), "code", "hash"), " ");
